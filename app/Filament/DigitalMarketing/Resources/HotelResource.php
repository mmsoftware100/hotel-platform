...
use App\Filament\DigitalMarketing\Resources\HotelResource\Pages;
use App\Filament\DigitalMarketing\Resources\HotelResource\RelationManagers;
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->filters([
                        ...
                        SelectFilter::make('hotel_category_id')
                            ->label('Category')
                            ->relationship('category', 'name')
                            ->preload()
                            ->searchable(),

...
class DestinationCategoryResource extends Resource
{
    ...
    {
        $createdUserIds = \App\Models\DestinationCategory::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\DestinationCategory::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (DestinationCategory $record) {

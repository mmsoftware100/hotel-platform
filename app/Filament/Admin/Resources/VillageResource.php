...
class VillageResource extends Resource
{
    ...
    {
        $createdUserIds = \App\Models\Village::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\Village::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('township.name')->searchable()->limit(20)->toggleable(),
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (Village $record) {

...
//destination and 5
    ...
    {
        $createdUserIds = \App\Models\Attraction::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\Attraction::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (Attraction $record) {

...
class HotelCategoryResource extends Resource
{
    ...
    {
        $createdUserIds = \App\Models\HotelCategory::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\HotelCategory::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (HotelCategory $record) {

...
class TownshipResource extends Resource
{
    ...
    {
        $createdUserIds = \App\Models\Township::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\Township::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (Township $record) {

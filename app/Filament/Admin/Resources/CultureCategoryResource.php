...
class CultureCategoryResource extends Resource
{
    ...
    {
        $createdUserIds = \App\Models\CultureCategory::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\CultureCategory::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (CultureCategory $record) {

...
class RestaurantCategoryResource extends Resource
{
    ...
    {
        $createdUserIds = \App\Models\RestaurantCategory::pluck('created_by')->unique()->filter();
        $createdUsers = \App\Models\User::whereIn('id', $createdUserIds)->pluck('name', 'id');        

        $updatedUserIds = \App\Models\RestaurantCategory::pluck('updated_by')->unique()->filter();
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ->before(function (RestaurantCategory $record) {
